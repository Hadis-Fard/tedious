...
describe('login7-payload', () => {
  ...
  describe('createFedAuth with password auth', () => {
    let payload = undefined;
    let data = undefined;
  ...
  }); // createFedAuth with password auth

  describe('createFedAuth with access token', () => {
